...
map("i", "<C-[>", "<esc><cmd>BufferLineCyclePrev<cr>a", { desc = "Prev Buffer" })
map("n", "<C-{>", "<cmd>BufferLineMovePrev<cr>", { desc = "Move Buffer Prev" })
map("i", "<C-{>", "<esc><cmd>BufferLineMovePrev<cr>a", { desc = "Move Buffer Prev" })
map("n", "<C-]>", "<cmd>BufferLineCycleNext<cr>", { desc = "Next Buffer" })
map("i", "<C-]>", "<esc><cmd>BufferLineCycleNext<cr>a", { desc = "Next Buffer" })
map("n", "<C-}>", "<cmd>BufferLineMoveNext<cr>", { desc = "Move Buffer Next" })
map("i", "<C-}>", "<esc><cmd>BufferLineMoveNext<cr>a", { desc = "Move Buffer Next" })
map("n", "<C-d>", function()
  Snacks.bufdelete()
...
map("i", "<C-z>", "<esc>ui")
map("n", "<C-z>", "u")
map({ "n", "x" }, "<C-a>", "<cmd>normal! gg<S-v>G<cr>", { desc = "Select All" })
map("i", "<C-a>", "<esc><cmd>normal! gg<S-v>G<cr>", { desc = "Select All" })
map("n", "<S-A-Up>", "yyP")
map("i", "<S-A-Up>", "<esc>yyPi")
map("v", "<S-A-Up>", "<esc>yyPv")
map("n", "<S-A-Down>", "yyp")
map("i", "<S-A-Down>", "<esc>yypi")
map("v", "<S-A-Down>", "<esc>yypv")
map("x", "<tab>", ">")
map("x", "<S-tab>", "<")
map({ "n", "x" }, "<C-Right>", "e")
